...
function calculateAndSendAverage() {
    ...
    // *** MODIFIED: Round the average price to 2 decimal places ***
    ...
    if (shouldSend) {
        // The payload will now contain the clean, rounded price.
...
// Binance: Relies on standard ping/pong, handled automatically by `ws`.
