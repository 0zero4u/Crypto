...
const FLAG_EXPIRY_CHECK_INTERVAL_MS = 100;

// --- Tunable Parameters ---
const MIN_STABLE_TICKS_FOR_ALERT_BT = 3;
const CRITICAL_LOW_ASK_QTY_THRESHOLD_BT_BTC = 0.01;
const CRITICAL_LOW_BID_QTY_THRESHOLD_BT_BTC = 0.01;
const MIN_DEPLETION_PERCENT_FROM_INITIAL_BT = 0.70;
const MIN_AGG_TRADE_CONFIRMATION_QTY_BTC = 0.1;
const MAX_TIME_WINDOW_FOR_CONFIRMATION_MS = 200;
