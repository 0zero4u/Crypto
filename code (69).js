...
const MODEL_VERSION = "2.7-quiet-neutral"; // Updated model version
...
function processTrade(data) {
    try {
        ...
        // *** MODIFIED: Logic to suppress updates during NEUTRAL periods ***
        ...
        // Send an update IF:
        // 1. The bias has changed (e.g., WEAK_BUY -> NEUTRAL). This is essential.
        // OR
        // 2. The bias is active (NOT NEUTRAL) AND the score has changed significantly.
        const shouldSendUpdate = biasChanged || (scoreChangedSignificantly && currentBias !== 'NEUTRAL');
