...
const CUMULATIVE_SCORE_THRESHOLD_BUY = 1.0;  // Increased threshold to reduce signal frequency
const CUMULATIVE_SCORE_THRESHOLD_SELL = -1.0; // Increased threshold to reduce signal frequency
