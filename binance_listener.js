...
const ALPHA = 6.0,   // Imbalance (Represents 50% of influence)
      BETA = 2.0,    // Absorption (Represents 7.5% of influence)
...
const CUMULATIVE_SCORE_THRESHOLD_BUY = 10.0;  // Increased threshold to reduce signal frequency
const CUMULATIVE_SCORE_THRESHOLD_SELL = -10.0; // Increased threshold to reduce signal frequency
