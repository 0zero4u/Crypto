...
// Final Production Version: Logging is minimized to critical events only:
// - Process startup (PID and parameters)
// - All errors (connection, parsing, internal sending)
...
function connectToCoinSwitchStream() {
    ...
    coinswitchSocket.on('connect', () => {
        // Successful connection is silent. Absence of errors is success.
    ...
    coinswitchSocket.on('disconnect', (reason) => {
        // Log disconnections as they are critical service interruptions.
...
// Critical "birth" message. Essential for process management.
