...
const CUMULATIVE_SCORE_THRESHOLD_BUY = 100.0;  // Threshold for the combined score to trigger a BUY
const CUMULATIVE_SCORE_THRESHOLD_SELL = -100.0; // Threshold for the combined score to trigger a SELL
