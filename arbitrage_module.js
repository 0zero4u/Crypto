...
const DESIRED_PROFIT_THRESHOLD_USD = 6.0;
const CLEARANCE_PROFIT_FLOOR_USD = 1.0;
const TOTAL_FEES_PER_UNIT_USD = 0.2;
const ARBITRAGE_CHECK_INTERVAL_MS = 80;

// --- Book Skew Configuration ---
const FAVORABLE_SKEW_RATIO_SELL_SIDE_HEAVY = 1.5;
const FAVORABLE_SKEW_RATIO_BUY_SIDE_HEAVY = 1.5;
const MIN_TOTAL_TOP_LEVEL_QTY_FOR_SKEW_CHECK = 0.1;
const MODERATE_SKEW_PENALTY_USD = 2.0;
const CRITICAL_SKEW_PENALTY_USD = 200.0;
